...
class LessonDetailView(DetailView, FormView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('main:lesson_detail',kwargs={'standard':standard.slug,
...
class LessonCreateView(CreateView):
    ...
    def get_success_url(self):
        self.object = self.get_object()
        standard = self.object.standard
        return reverse_lazy('main:lesson_list', kwargs={'standard': standard.slug,
                                                        'slug': self.object.slug})
...
class LessonDeleteView(DeleteView):
    ...
    def get_success_url(self):
        ...
        standard = self.object.Standard
        subject = self.object.subject
        return reverse_lazy('main:lesson_list', kwargs={'standard': standard.slug,'slug': subject.slug})